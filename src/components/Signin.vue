                ...
                <div class="card-header">
                  ...
                  <form @submit.prevent="submitLogin">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="email" required="" v-model="email" placeholder="admin@gmail.com">
                    </div>
